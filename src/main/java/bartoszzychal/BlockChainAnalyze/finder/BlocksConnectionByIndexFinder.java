...
public class BlocksConnectionByIndexFinder {

    private static final Logger log = Logger.getLogger(BlocksConnectionByIndexFinder.class);

	public BlocksConnectionByIndexFinder() {
